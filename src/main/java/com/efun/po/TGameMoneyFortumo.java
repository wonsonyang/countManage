...
/**
 * TGameMoneyFortumo entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class TGameMoneyFortumo implements java.io.Serializable {
	private static final long serialVersionUID = -2098123995805927355L;
	...
	/** default constructor */
	public TGameMoneyFortumo() {
	}

	/** full constructor */
	public TGameMoneyFortumo(String gameCode, String serverCode, Long uid,
			String creditId, String payStatus, String resultCode,
			String efunOrderId, String transactionId, String productId,
			String moneyType, String payFrom, String payType, Float gamePay,
			Float stone, Float usd, Float twCoin, Date createdTime,
			Date modifiedTime, String efunRole, String efunLevel, String paid,
			String packageName, String flag, String remark, String country) {
