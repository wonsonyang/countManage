...
/**
 * TGameMoneyMolstore entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class TGameMoneyMolstore implements java.io.Serializable {
	private static final long serialVersionUID = -8041286898887364928L;
	...
	/** default constructor */
	public TGameMoneyMolstore() {
	}

	/** full constructor */
	public TGameMoneyMolstore(String gameCode, String serverCode, Long uid,
			...
			String packageName, String country) {
