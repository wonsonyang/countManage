...
/**
 * TPfMemberGoods entity. @author MyEclipse Persistence Tools
 */

public class TPfMemberGoods implements java.io.Serializable {
	...
	/** default constructor */
	public TPfMemberGoods() {
	}

	/** minimal constructor */
	public TPfMemberGoods(String id, String deductType, Integer totalCount, Timestamp createdTime,
	...
	/** full constructor */
	public TPfMemberGoods(String id, String gameCode, String goodsName, String awardDesc,
