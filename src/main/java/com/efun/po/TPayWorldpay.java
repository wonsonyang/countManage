...
/**
 * TPayWorldpay entity. @author MyEclipse Persistence Tools
 */

public class TPayWorldpay implements java.io.Serializable {
	private static final long serialVersionUID = 7286439189260428108L;
	...
	/** minimal constructor */
	public TPayWorldpay(String userId, String gameCode, String serverCode, String creditId,
			Double usd, String currency, String flag, String payFrom, String payType,
			String payStatus, String efunOrderId, String transactionId, Timestamp createdTime,
			Timestamp modifiedTime, Timestamp areaTime) {
		this.userId = userId;
	...
	/** full constructor */
	public TPayWorldpay(String userId, String gameCode, String serverCode, String creditId,
			Integer efunLevel, Double gamePoint, Double amount, Double areaAmount, Double usd,
			Integer stone, String currency, String flag, String paid, String payFrom,
			String payType, String productId, String payStatus, String efunOrderId,
			String transactionId, Timestamp createdTime, Timestamp modifiedTime, String country,
			Short reSend, Short isTest, String resultCode, String ip, String menuId, String itemId,
			Integer activityStone, String packageName, Timestamp areaTime, String remark,
			String efunToken, String paymentToken, String backup, String advertisingid,
			String deviceType, String systemVersion, String mac, String imei, String versionCode,
			String gameVersion, String idfa, String cfuuid, String androidid,
			String efunFundAccount, Short isTort, String str1, String str2, String str3, String str4) {
		this.userId = userId;
		this.gameCode = gameCode;
		this.serverCode = serverCode;
		this.creditId = creditId;
