...
/**
 * TGamePointFree entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class TGamePointFree implements java.io.Serializable {
	private static final long serialVersionUID = 6363051782923848876L;
	...
	/** default constructor */
	public TGamePointFree() {
	}

	/** minimal constructor */
	public TGamePointFree(Long uid, String pointOrderId, Float freePoint,
			String pointCode, String payStatus) {
		this.uid = uid;
	...
	/** full constructor */
	public TGamePointFree(Long uid, String pointOrderId, String thirdOrderId,
			String flag, Float freePoint, String pointCode, Float gamePoint,
			Float gamePay, String currency, Float twCoin, Float usd,
			String gameCode, String serverCode, Float stone, Float donate,
			Float bouns, String creditId, String roleLevel, String payType,
			String payFrom, String payStatus, String pointOrderStatus,
			String resend, Date createdTime, Date modifiedTime, String remark,
			String comment, String productId, String reserve1, String reserve2,
