...
/**
 * TGameMoneyXsolla entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class TGameMoneyXsolla implements java.io.Serializable {
	private static final long serialVersionUID = 5145191605018964222L;
	...
	/** default constructor */
	public TGameMoneyXsolla() {
	}

	/** full constructor */
	public TGameMoneyXsolla(String gameCode, String serverCode, Long uid,
			String creditId, String payStatus, String efunOrderId,
			String transactionId, String moneyType, String payFrom,
			String payType, Float gamePay, Float stone, Float usd,
			Float twCoin, Date createdTime, Date modifiedTime,
			String efunLevel, String flag, String remark, String packageName,
			String country, String pid) {
