...
/**
 * TPayApacpay entity. @author MyEclipse Persistence Tools
 */

public class TPayApacpay implements java.io.Serializable {
	...
	/** minimal constructor */
	public TPayApacpay(String userId, String gameCode, String serverCode, String creditId,
