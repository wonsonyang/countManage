...
/**
 * TPayMycard entity. @author MyEclipse Persistence Tools
 */

public class TPayMycard implements java.io.Serializable {
	private static final long serialVersionUID = 3359785851418066030L;
	...
	/** minimal constructor */
	public TPayMycard(String userId, String gameCode, String serverCode,
			String creditId, String currency, String flag, String payFrom,
			String payType, String payStatus, String efunOrderId,
			String transactionId, Timestamp createdTime,
	...
	/** full constructor */
	public TPayMycard(String userId, String gameCode, String serverCode,
			String creditId, Integer efunLevel, Double gamePoint,
			Double amount, Double areaAmount, Double usd, Integer stone,
			String currency, String flag, String paid, String payFrom,
			String payType, String productId, String payStatus,
			String efunOrderId, String transactionId, Timestamp createdTime,
			Timestamp modifiedTime, String country, Short reSend, Short isTest,
			String resultCode, String ip, String menuId, String itemId,
			Integer activityStone, String packageName, Timestamp areaTime,
			String remark, String efunToken, String paymentToken,
			String backup, String advertisingid, String deviceType,
			String systemVersion, String mac, String imei, String versionCode,
			String gameVersion, String idfa, String cfuuid, String androidid,
			String efunFundAccount, Short isTort, String str1, String str2,
