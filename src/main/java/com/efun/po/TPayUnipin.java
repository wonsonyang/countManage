...
/**
 * TPayUnipin entity. @author MyEclipse Persistence Tools
 */

public class TPayUnipin implements java.io.Serializable {
	...
	/** minimal constructor */
	public TPayUnipin(String userId, String gameCode, String serverCode, String creditId, Double usd, String currency, String flag, String payFrom, String payType, String payStatus, String efunOrderId, String transactionId, Timestamp createdTime, Timestamp modifiedTime, Timestamp areaTime) {
		this.userId = userId;
	...
	/** full constructor */
	public TPayUnipin(String userId, String gameCode, String serverCode, String creditId, Integer efunLevel, Double gamePoint, Double amount, Double areaAmount, Double usd, Integer stone, String currency, String flag, String paid, String payFrom, String payType, String productId, String payStatus,
