...
/**
 * TPayAppstore entity. @author MyEclipse Persistence Tools
 */

public class TPayAppstore implements java.io.Serializable {
	private static final long serialVersionUID = 6368233257534232107L;
	...
	/** minimal constructor */
	public TPayAppstore(String gameCode, String serverCode, Double usd, String currency, String flag, String payFrom,
			String payType, String payStatus, String efunOrderId, String transactionId, Timestamp createdTime,
	...
	/** full constructor */
	public TPayAppstore(String userId, String gameCode, String serverCode, String creditId, Integer efunLevel,
