...
/**
 * TPayGoogleplay entity. @author MyEclipse Persistence Tools
 */

public class TPayGoogleplay implements java.io.Serializable {
	private static final long serialVersionUID = -8415848303185568626L;
	...
	/** default constructor */
	public TPayGoogleplay() {
	}

	/** minimal constructor */
	public TPayGoogleplay(Double usd, String currency, String flag, String payFrom, String payType, String payStatus,
			String efunOrderId, String transactionId, Timestamp createdTime, Timestamp modifiedTime,
			Timestamp areaTime) {
		this.usd = usd;
	...
	/** full constructor */
	public TPayGoogleplay(String userId, String gameCode, String serverCode, String creditId, Integer efunLevel,
