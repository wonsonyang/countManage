...
public class HttpsUtil {
	 ...
	 * @return URL的返回内容
	 */
	private static final String getUrlReturnValue(String urlAddress, String charset, String method) {
	...
	private static final String getUrlReturnValue(String urlAddress, String charset, String method,
		...
		if (!urlAddress.startsWith("https:")) {
			return urlReturnValue(urlAddress, charset, method, paramsMap, paramsKeyList, requestPropertiesMap);
		}
	 ...
	 */
	private static final int getUrlAccessCode(String urlAddress, String charset, String method,
			Map<String, String> paramsMap, List<String> paramsKeyList, Map<String, String> requestPropertiesMap) {
		if (urlAddress == null) {
			throw new IllegalArgumentException("param 'urlAddress' is required");
		}
		if (!urlAddress.startsWith("https:")) {
			return urlAccessCode(urlAddress, charset, method, paramsMap, paramsKeyList, requestPropertiesMap);
		}
		HttpsURLConnection conn = null;
		int tempCode = -1;
		try {
	 ...
	 * @return URL的返回内容
	 */
	private static final String urlReturnValue(String urlAddress, String charset, String method,
			Map<String, String> paramsMap, List<String> paramsKeyList, Map<String, String> requestPropertiesMap) {
		if (urlAddress == null) {
			throw new IllegalArgumentException("param 'urlAddress' is required");
		}
		if (urlAddress.startsWith("https:")) {
			return getUrlReturnValue(urlAddress, charset, method, paramsMap, paramsKeyList, requestPropertiesMap);
		}
	 ...
	 * @return status code from an HTTP response message
	 */
	private static final int urlAccessCode(String urlAddress, String charset, String method,
			Map<String, String> paramsMap, List<String> paramsKeyList, Map<String, String> requestPropertiesMap) {
		if (urlAddress == null) {
			throw new IllegalArgumentException("param 'urlAddress' is required");
		}
		if (urlAddress.startsWith("https:")) {
			return getUrlAccessCode(urlAddress, charset, method, paramsMap, paramsKeyList, requestPropertiesMap);
		}
		HttpURLConnection conn = null;
		int tempCode = -1;
		try {
